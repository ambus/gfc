...
exports.buildNpmPackage = series(release, cleanDistDirectory, build, addRunCommandInBuildFile, copyPackageFileToDistPath, updatePackageFile, makeFileExecutable, buildNpmPackage);
exports.buildNpmPackageWithoutRelease = series(cleanDistDirectory, build, addRunCommandInBuildFile, copyPackageFileToDistPath, updatePackageFile, makeFileExecutable, buildNpmPackage);
